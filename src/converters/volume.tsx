...
export default function VolumeConverter() {
  ...
  return (
    <ConverterCard accentColor="bg-teal-300">
      <div className="text-right">
        <h2 className="text-xl font-bold text-blue-800">המרת נפח</h2>
        ...
        <div className="mt-4 flex flex-row-reverse gap-4">
          ...
          >
            {Object.entries(VOLUME_UNIT_LABELS).map(([id, label]) => (
        ...
        <div className="mt-6 rounded-xl bg-blue-50 px-4 py-3 text-lg font-bold text-blue-600">
          {result} {VOLUME_UNIT_LABELS[toUnit]}
        </div>
      </div>
    </ConverterCard>
  );
