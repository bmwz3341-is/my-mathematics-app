...
export default function WeightConverter() {
  ...
  return (
    <ConverterCard accentColor="bg-orange-300">
      <div className="text-right">
        <h2 className="text-xl font-bold text-blue-800">המרת משקל</h2>
        ...
        <div className="mt-4 flex flex-row-reverse gap-4">
          ...
          >
            {Object.entries(WEIGHT_UNIT_LABELS).map(([id, label]) => (
        ...
        <div className="mt-6 rounded-xl bg-blue-50 px-4 py-3 text-lg font-bold text-blue-600">
          {result} {WEIGHT_UNIT_LABELS[toUnit]}
        </div>
      </div>
    </ConverterCard>
  );
