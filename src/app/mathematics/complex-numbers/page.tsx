...
import ComplexNumberSolver from "@/components/mathematics/ComplexNumberSolver";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">מספרים מרוכבים</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          פעולות חשבון, המרות בין הצגה אלגברית (a+bi) לטריגונומטרית (r·cis θ), חזקות ושורשים לפי משפט דה-מואבר
          ומשוואות עם הנעלם z — עם פירוט שלב-אחר-שלב והצגה במישור גאוס
        </p>
