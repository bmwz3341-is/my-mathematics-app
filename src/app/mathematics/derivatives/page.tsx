...
import DerivativeCalculator from "@/components/mathematics/DerivativeCalculator";
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">
          גזירת פונקציות והצגה בגרף
        </h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו פונקציה פולינומית וקבלו את הנגזרת שלה בכתב, שלב אחר שלב, לצד גרפים של הפונקציה והנגזרת
        </p>
