...
import System3EquationsSolver from "@/components/mathematics/System3EquationsSolver";

const heebo = Heebo({ subsets: ["hebrew", "latin"], weight: ["400", "500", "700", "800"] });

export default function System3EquationsPage() {
  return (
    <div
      dir="rtl"
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">מערכת 3 משוואות ב-3 נעלמים</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו שלוש משוואות לינאריות (a₁x + b₁y + c₁z = d₁) וקבלו פתרון בשיטת הדירוג (גאוס) שלב אחר שלב — ביטול נעלם, פתרון מערכת 2×2, הצבה לאחור, בדיקה והצגה גרפית של התוצאה
        </p>

        <div className="mt-6">
          <System3EquationsSolver />
        </div>
      </div>
