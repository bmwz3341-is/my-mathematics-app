...
import ScientificCalculator from "@/components/mathematics/ScientificCalculator";
    ...
    >
      ...
      <div className="relative mx-auto max-w-md">
        ...
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          טריגונומטריה, לוגריתמים, חזקות, שורשים, קומבינטוריקה וזיכרון — בהשראת Casio FX-991ES PLUS
        </p>
