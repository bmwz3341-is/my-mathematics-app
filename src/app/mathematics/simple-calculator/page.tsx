...
import SimpleCalculator from "@/components/mathematics/SimpleCalculator";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">מחשבון פשוט</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          חיבור, חיסור, כפל, חילוק, אחוזים וזיכרון — הכל במקום אחד
        </p>
