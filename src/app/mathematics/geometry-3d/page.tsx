...
import SpaceGeometrySolver from "@/components/mathematics/SpaceGeometrySolver";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">גיאומטריה של המרחב</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          שתי סביבות עבודה: נקודות במרחב (מרחק, אמצע קטע, וקטור, קולינאריות וחלוקת קטע ביחס) וגופים במרחב (תיבה, קובייה ופירמידה — נפח, שטח פנים, אלכסונים וזוויות עם הבסיס), עם פתרון שלב אחר שלב
        </p>
