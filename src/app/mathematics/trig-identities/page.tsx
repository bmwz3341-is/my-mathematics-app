...
import TrigIdentitiesSolver from "@/components/mathematics/TrigIdentitiesSolver";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">זהויות טריגונומטריות</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו ביטוי טריגונומטרי (sin, cos, tan) ולחצו על &quot;פשט&quot; — המנוע ינסה זהויות פיתגורס, זווית כפולה, זווית מחצית וסכום/הפרש בזו אחר זו, ויציג את שלבי הפישוט עם הסבר לכל שלב
        </p>

        <div className="mt-6">
          <TrigIdentitiesSolver />
        </div>
      </div>
