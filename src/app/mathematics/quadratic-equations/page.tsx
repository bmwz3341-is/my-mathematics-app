...
import QuadraticEquationSolver from "@/components/mathematics/QuadraticEquationSolver";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">משוואות ריבועיות</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו משוואה ריבועית (גם אם אינה מסודרת) וקבלו פתרון מדויק לפי שיטת הדיסקרימיננטה, שלב אחר שלב, עם הצגה גרפית
        </p>
