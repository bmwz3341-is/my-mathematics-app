...
import IntegralCalculator from "@/components/mathematics/IntegralCalculator";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">חישוב אינטגרלים</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו פונקציה (חזקות, sin, cos או e^x), בחרו אינטגרל לא מסוים או מסוים, וקבלו פתרון מדויק שלב אחר שלב עם הצגה גרפית של השטח תחת הגרף
        </p>
