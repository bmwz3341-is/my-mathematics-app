...
import ArithmeticSequenceSolver from "@/components/mathematics/ArithmeticSequenceSolver";

const heebo = Heebo({ subsets: ["hebrew", "latin"], weight: ["400", "500", "700", "800"] });

export default function ArithmeticSequencesPage() {
  return (
    <div
      dir="rtl"
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">סדרות חשבוניות</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו את הנתונים הידועים של הסדרה (a₁, d, n, aₙ, Sₙ) והמנוע ישלים את הפרמטרים החסרים, ימצא את האיבר הכללי ואת הסכום — שלב אחר שלב עם הצגה גרפית
        </p>
