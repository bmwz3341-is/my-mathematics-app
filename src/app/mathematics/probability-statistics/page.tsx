  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">הסתברות וסטטיסטיקה</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          בחרו את סוג הבעיה — הסתברות קלאסית, הסתברות מותנית ונוסחת בייס, התפלגות בינומית, סטטיסטיקה תיאורית או התפלגות נורמלית — והזינו את הנתונים לפתרון שלב אחר שלב
        </p>
