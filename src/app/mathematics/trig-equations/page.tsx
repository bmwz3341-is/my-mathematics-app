...
import TrigEquationsSolver from "@/components/mathematics/TrigEquationsSolver";

const heebo = Heebo({ subsets: ["hebrew", "latin"], weight: ["400", "500", "700", "800"] });

export default function TrigEquationsPage() {
  return (
    <div
      dir="rtl"
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">משוואות טריגונומטריות</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          בחרו צורת משוואה (בסיסית, ריבועית בפונקציה אחת, או צירוף לינארי של sin ו-cos), הזינו את המקדמים, הארגומנט והטווח, וקבלו את הפתרון הכללי עם k∈ℤ ואת כל הפתרונות הספציפיים בטווח
        </p>
