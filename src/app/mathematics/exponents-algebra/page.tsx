...
import PowersAlgebra from "@/components/mathematics/PowersAlgebra";

const heebo = Heebo({ subsets: ["hebrew", "latin"], weight: ["400", "500", "700", "800"] });

export default function ExponentsAlgebraPage() {
  return (
    <div
      dir="rtl"
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">
          חזקות ומשוואות מעריכיות
        </h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו ביטוי חזקות וקבלו פישוט מדויק לפי חוקי החזקות, שלב אחר שלב
        </p>
