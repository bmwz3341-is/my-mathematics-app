...
import FunctionAnalysis from "@/components/mathematics/FunctionAnalysis";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">חקירת פונקציות</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו פונקציה פולינומית, קבלו את הנגזרת שלה, ומצאו את נקודות הקיצון וסיווגן לפי הנגזרת השנייה — עם סימון על הגרף
        </p>
