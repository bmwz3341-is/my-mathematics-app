...
import AlgebraicVectorsSolver from "@/components/mathematics/AlgebraicVectorsSolver";

const heebo = Heebo({ subsets: ["hebrew", "latin"], weight: ["400", "500", "700", "800"] });

export default function AlgebraicVectorsPage() {
  return (
    <div
      dir="rtl"
    ...
    >
      ...
      <div className="relative">
        <h1 className="text-right text-2xl font-extrabold text-orange-500 sm:text-3xl">וקטורים אלגבריים</h1>
        <p className="mt-4 text-right text-sm font-medium text-slate-600">
          הזינו וקטורים תלת-ממדיים ובחרו פעולה — חיבור, חיסור, כפל בסקלר, מכפלה סקלרית, אורך וקטור או זווית בין וקטורים — וקבלו פתרון שלב אחר שלב, רכיב-רכיב
        </p>

        <div className="mt-6">
          <AlgebraicVectorsSolver />
        </div>
      </div>
